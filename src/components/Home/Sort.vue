<template>
  <div class="dropdown">
    ...
    <ol @click="handleShowSort">
      ...
      <li type="submit" @click="handleSort('name&order=DESC')">
        <a href="#">z-a</a>
      </li>
      <li type="submit" @click="handleSort('price')">
        <a href="#">low price</a>
      </li>
      <li type="submit" @click="handleSort('price&order=DESC')">
        <a href="#">high price</a>
      </li>
    </ol>
  </div>
...
export default {
  ...
  methods: {
    ...mapActions(['getDataSort', 'getAllData', 'getData']),
    handleSort (sortir) {
      const data = {
        search: this.search,
        sort: sortir
